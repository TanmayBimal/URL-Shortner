...
const LandingPage = () => {
  ...
  return (
    <div className='flex flex-col items-center'>
      <h2 className='my-10 sm:my-16 text-3xl sm:text-6xl lg:text-7xl text-gray-800 text-center font-extrabold'>
      ...
      <form onSubmit={handleShorten} className='sm:h-14 flex flex-col sm:flex-row w-full md:w-2/4 gap-2'>
        ...
        className="h-full flex1 py-4 px-4"
        />
       <Button 
       
       className="h-full bg-red-500" type="submit" variant="destructive" >Shorten!</Button>
      </form>
  ...
  <AccordionItem value="item-3">
    ...
    <AccordionContent>
     You can view the number of clicks, geolocation data of the clicks and device types (mobiles/desktop) for each of your shortened URLs.
    </AccordionContent>
  </AccordionItem>
</Accordion>
